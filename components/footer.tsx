    ...
    return(
        ...
        <div className="Frame45 h-[140px] flex-col justify-center items-start gap-2.5 inline-flex absolute z-40 pl-[5%]">
          ...
          <div className="Frame44 opacity-50 justify-start items-center gap-[5px] inline-flex">
            <div className="DiscordOpscanCom text-center text-white font-normal font-['SF Pro Text'] leading-tight" id={styles.small}><a href="discord.gg/opscans">Discord &</a></div>
            <div className="TwitterOpscanCom text-center text-white font-normal font-['SF Pro Text'] leading-tight" id={styles.small}><a href="https://twitter.com/OPSCANS">Twitter</a></div>
          </div>
